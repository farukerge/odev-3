...
const categories = menu.reduce((currentValues, item) =>
{
    if (!currentValues.includes(item.category)) {
      currentValues.push(item.category);
    }
...
const categoryList = () => {
  ...
  filterBtns.forEach((btn) => {
    btn.addEventListener("click", (elem) => {
      const category = elem.currentTarget.dataset.id;
